...
//    Resource Rsc_2 = Resource(0, 2, 2);
    ...
    int TskIndex = 0;
    int RscIndex = 0;
    string RscAlcPath = FilePath + "/" + RscAlcFile;  //RscAlcPath
...
void ConfigParameter_TDTSGA() {
    Parameter_TDTSGA.NumOfChormPerPop = 70*Tasks.size();
    if (Parameter_TDTSGA.NumOfChormPerPop % 2 == 1) {
        ++Parameter_TDTSGA.NumOfChormPerPop;
    }
    Parameter_TDTSGA.MutationRate1 = 0.8;
    Parameter_TDTSGA.MutationRate2 = 0.4;
    Parameter_TDTSGA.beta = 35;
    Parameter_TDTSGA.RunTimeRatioOfStg1 = 0.7;
}